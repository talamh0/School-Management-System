...
public class StudentsInSubjectForStudent {
    ...
    StudentsInSubjectForStudent(DriverClass driverClass,String subjectName){
    ...
    public void createStudentTable() {
        String[][] studentsTable = driverClass.retrieveStudentsInSubjects(subjectName,driverClass.userID);
